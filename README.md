...
On first launch, you'll be asked if you want to download sound effects
Sound files (~100KB total) are automatically downloaded from the SoundFX collection
You can skip this and play without sound if preferred
...
This game uses free, open-source sound effects from the SoundFX Collection by Dr. Ralf S. Engelschall.
All sounds are licensed under either:


CC0 1.0 (Public Domain) - No attribution required, but appreciated

CC-BY 3.0 - Attribution required (included in this README)
...
Sound files are automatically downloaded from the SoundFX GitHub repository on first run.
